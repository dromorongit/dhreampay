...
const TransactionSchema = new Schema<ITransaction>({
  ...
  transactionType: { type: String, enum: ['purchase', 'refund', 'reversal', 'adjustment'], required: true },
  ...
  status: { type: String, enum: ['unmatched', 'matched', 'exception', 'resolved'], required: true, default: 'unmatched' },
